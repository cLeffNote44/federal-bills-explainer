...
async def readiness_probe(db: Session = None):
    """
...
async def get_metrics(
    ...
    logger.log_performance_metric(
        ...
        value=1,
        unit="count",
        cpu_percent=cpu_percent if include_system else None
    )
