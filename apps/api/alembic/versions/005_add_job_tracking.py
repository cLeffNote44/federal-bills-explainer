...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Additional metadata
        sa.Column('triggered_by', sa.String(100), nullable=True),  # user, scheduler, manual
    ...
    op.create_table(
        ...
        sa.Column('level', sa.String(20), nullable=False),  # INFO, WARNING, ERROR, DEBUG
        sa.Column('message', sa.Text(), nullable=False),
        sa.Column('details', postgresql.JSONB, nullable=True),
        sa.Column('record_id', sa.String(100), nullable=True),  # External ID of the record being processed
...
def downgrade() -> None:
    ...
    # Drop enum
    job_status_enum = postgresql.ENUM('pending', 'running', 'completed', 'failed', 'cancelled', name='job_status_enum')
